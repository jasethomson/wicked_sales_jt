...
- [ ]Add a property to App’s initial state named view that is an Object with two properties; name and params. name is a String set to "catalog" and params is an empty Object. i.e. { name: 'catalog', params: {} }
